...
export default {
  ...
  methods: {
    async registerUser() {
      try {
        console.log('Enviando dados:', this.user); // Adicione isso para verificar os dados enviados
        ...
        console.log('Resposta do servidor:', response); // Adicione isso para verificar a resposta do servidor
        ...
        if (response.ok) {
          ...
          console.error('Erro detalhado:', errorData); // Adicione isso para verificar o erro detalhado
